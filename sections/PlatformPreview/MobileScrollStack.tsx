...
/**
 * Original ScrollStack (React Bits–style) for mobile only.
 * Completely separate from the desktop-optimized implementation.
 */
const MobileScrollStack: React.FC<MobileScrollStackProps> = ({
  children,
  className = "",
  itemDistance = 100,
  itemScale = 0.03,
