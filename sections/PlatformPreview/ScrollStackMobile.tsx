...
/**
 * Original ScrollStack (pre mobile-perf optimizations).
 * Prefer this on touch viewports — simpler scroll path feels smoother there.
 */
const ScrollStackMobile: React.FC<ScrollStackProps> = ({
  children,
  className = "",
  itemDistance = 100,
  itemScale = 0.03,
...
export default ScrollStackMobile;
